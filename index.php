...
@keyframes glowPulse {
    0%, 100% { filter: drop-shadow(0 0 6px #00FA9A); }
    50% { filter: drop-shadow(0 0 14px #00FA9A); }
}
...
.logo-header i {
    font-size: 2.3rem;
    color: #00FA9A;
    animation: floatRocket 3s ease-in-out infinite, glowPulse 2s ease-in-out infinite;
}
.logo-header h1 {
    font-size: 1.9rem;
    font-weight: 700;
...
.container-auth {
    ...
    max-width: 90%;
    text-align: center;
    border: 1px solid rgba(20,255,200,0.3);
...
toggleForm.addEventListener('click', () => {
    ...
    if (formTitle.innerText === 'Login') {
        ...
        toggleForm.innerText = 'Switch to Login';
    } else {
        formTitle.innerText = 'Login';
        toggleForm.innerText = 'Switch to Register';
    }
});
